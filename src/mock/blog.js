      ...
      [`rows|${query.limit || 10}`]: [
        {
          ...
          "thumb|1": ["@image(300 x 250, @color, #fff, aDai)"],
          createDate: `@date('T')`,
        },
      ],
    },
...
Mock.mock(/^\/api\/blog\/[^/]+$/, "get", {
  ...
  data: {
    id: "@guid", //浏览次数,
    title: "CORS跨域方案详解", //博客标题
    category: {
      "id|1-10": 1,
      name: "分类@id",
    },
    "scanNumber|200-3000": 0, // 浏览次数
    "commentNumber|50-1000": 0, //评论数
    description: "@cparagraph(5,15)", //博客描述，显示到列表页"
    ...
    // 缩略图地址
    "thumb|1": [
      Mock.Random.image("300 x 250", "#000", "#fff", "Random image"),
      null,
    ],
    //博客的html内容
...
Mock.mock("/api/comment", "post", {
  ...
  data: {
    id: "@guid",
    nickname: "@cname", //昵称,
    content: "@cparagraph(5,10)", //"评论内容，纯文本",
    createDate: Date.now(), // 1604976798936,
    "avatar|1": [
    ...
    data: {
      ...
      [`rows|${query.limit || 10}`]: [
        // 当前页列表数据
        {
          id: "@guid",
          nickname: "@cname", //"昵称",
          content: "@cparagraph(5,20)", //"评论内容，纯文本",
          createDate: Date.now(), //1604976798936,
          "avatar|1": [
            "https://qiheizhiya.oss-cn-shenzhen.aliyuncs.com/image/avatar6.jpg",
            "https://qiheizhiya.oss-cn-shenzhen.aliyuncs.com/image/avatar4.jpg",
